...
use App\Core\CRUD\Img_Course;
use App\Core\Box\Tools;

require_once '../App/Core/CRUD/ImgCourse.php';
...
function delete()
{
    $service_id = filter_input(INPUT_POST, 'id_curso', FILTER_SANITIZE_NUMBER_INT);
