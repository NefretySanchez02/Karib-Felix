 ...
 */
class Img_Course extends Model
{
    const SQL_TABLE = "imagenes_curso";

    const MODEL_CONFIG = array(
        "tablename" => "imagenes_curso",
        "fields" => array(
            "id" => array("type" => "INT", "length" => "10"),
            "foto" => array("type" => "STR", "length" => "250"),
            "id_curso" => array("type" => "INT", "length" => "10")
        )
    );
    ...
    {
        $sql = parent::generateListForColumn(self::SQL_TABLE, "id_curso", $tipo);
        $params = array(
    ...
    public static function createImagen($data)
    {
        $fields_array = array(
            ...
            array("field" => "id_curso", "value" => $data[1], "type" => "STR"),
        );
